...
-   **Live Website**: [gametrackerxp.vercel.app](https://gametrackerxp.vercel.app/)
-   **Source Data (Google Sheets)**: [2026 Release Calendar](https://docs.google.com/spreadsheets/d/1EbGHsJjxt4VrpD8_0jPZn2JMB7WNz945S1hFgfXWddg/edit?gid=328248417#gid=328248417)
-   **GitHub Repository**: [itslowkeyxp/game-tracker](https://github.com/itslowkeyxp/game-tracker)
...
-   `App.tsx`: The main application logic and UI components.
-   `data.ts`: The central game release database.
-   `types.ts`: TypeScript definitions for type safety.
-   `index.html`: Entry point with Tailwind and font configurations.

---
Developed with ❤️ by [itslowkeyxp](https://github.com/itslowkeyxp)
